...
public:
	...
	void Addrole(string name, Job job, string id)
	{
		...
		if (nameToIndex.find(name) != nameToIndex.end())
		{
			...
			default:cout << "继续添加：" << name << endl; break;
			}
		}
	...
	{
		cout << "\n========== 系统状态 ==========" << endl;
		cout << "角色数量：" << roleList.size() << " (使用vector存储)" << endl;
		cout << "存档数量：" << archiveStack.size() << " (使用stack存储)" << endl;
...
void test() {
	...
	while (1)
	{
		...
		case 0:
			...
			return;
			break;
		case 1:testadd(); cout << endl; break;
		case 2:testFind();  cout << endl; break;
		case 3:testlevelup();  cout << endl; break;
		case 4:testarchive();  cout << endl; break;
		case 5:testsort(); cout << endl; break;
		case 6:testrremove();  cout << endl; break;
		default:
			cout << "无效选择" << endl;
			break;
		}
